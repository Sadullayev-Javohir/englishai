...
public sealed class UpdateListeningExerciseCommandValidator
    : AbstractValidator<UpdateListeningExerciseCommand>
{
    public UpdateListeningExerciseCommandValidator()
    {
