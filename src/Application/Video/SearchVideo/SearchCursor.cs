...
/// <summary>
/// The opaque page cursor for video search: the active search term plus the source's
...
/// </summary>
internal sealed record SearchCursor(string SearchTerm, string? Continuation)
{
    ...
    public static SearchCursor? TryDecode(string? cursor)
    {
        ...
        try
        {
            ...
            var decoded = JsonSerializer.Deserialize<SearchCursor>(json);
